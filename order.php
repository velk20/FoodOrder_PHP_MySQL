    ...
    <section class="food-search">
        <div class="container">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($res2 == true) {
                    $_SESSION['order'] = "<div class='text-center' style='  color: #1ed268;
                    font-weight:bold ; padding: 2%;'>Food Ordered Successfully.</div>";
                    header('location:'.SITEURL);
                }else{
                    $_SESSION['order'] = "<div class='text-center' style='color: #ff4757;
                    font-weight:bold ; padding: 2%;'>Failed To order Food.</div>";
                    header('location:'.SITEURL);
                }
            }
            ?>
